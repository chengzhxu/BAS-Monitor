    ...
    public function getExcelColumn($str_cn = ''){
        ...
        $excel_columns = [
            ...
            ['name' => '广告结束时间', 'bas_key' => 'ad_time_end', 'necessary' => 1, 'format' => 'yyyy-mm-dd hh:ii:ss 例如：2019-08-31 23:59:59', 'example' => '2019-08-31 23:59:59',
                'column_number_format' => 'yyyy-mm-dd hh:mm:ss', 'strict_nom_empty' => 1,'is_view' => 1, 'is_model' => 1],
            ['name' => '每日频控', 'bas_key' => 'limit_day', 'necessary' => 1, 'example' => 0,'is_view' => 0, 'is_model' => 1, 'is_merge' => 1],
            ['name' => '每周频控', 'bas_key' => 'limit_week', 'necessary' => 1, 'example' => 0,'is_view' => 0, 'is_model' => 1, 'is_merge' => 1],
            ['name' => '周期频控', 'bas_key' => 'limit_period', 'necessary' => 1, 'example' => 0,'is_view' => 0, 'is_model' => 1, 'is_merge' => 1],
